    ...
    <div class="container">
      ...
      <form method='post' action='/adminlogin'>
        <div class="form-outline mb-4">
          <br>
          <label class="form-label" for="admin_loginid">ENTER LOGINID</label>
          <input type="text" id="admin_loginid" class="form-control" name='admin_loginid' value="<?= set_value('admin_loginid') ?>" />
