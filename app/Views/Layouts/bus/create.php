...
<div class="actionbutton mt-2">
    <a class="btn btn-info float-right mb20" href="<?= site_url('/index') ?>">List</a>
</div>
...
<div class="container">
            ...
            <form action="<?= site_url('busstore') ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="bus_capacity" aria-label="Default select example">
                        <option selected>SELECT BUS Capacity</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="bus_status" id="bus_status"
    ...
    <div class="form-group">
        ...
        <input type="datetime-local" name="departure" class="form-control" id="departure">
