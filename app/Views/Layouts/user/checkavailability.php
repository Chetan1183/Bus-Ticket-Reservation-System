...
<!-- 'bus_name','bus_number','bus_capacity','bus_status','origin','destination','departure','price' -->
        ...
        <tr>
          ...
          <td  style="height:50px">
            <?php if ($bus['bus_status'] == 'AVAILABLE') : ?>
              <a href="<?= base_url('bookbus/'.$bus['bus_id'])?>" class="btn btn-primary btn-sm">Book bus</a>
          </td>
          <td>
        <?php else : ?>
          room not available</td>
