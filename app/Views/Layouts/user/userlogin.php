    ...
    <div class="container">
      ...
      <form method='post' action='/userlogin'>
        <div class="form-outline mb-4">
          ...
          <input type="text" id="user_email" class="form-control" name='user_email' value="<?= set_value('user_email') ?>" />
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-8 text-right">
              <p>Not A Member? <a href="/register" style="color:#36AE7C;" >REGISTER</a></p>
          </div>
        </div>
      </form>
    </div>
